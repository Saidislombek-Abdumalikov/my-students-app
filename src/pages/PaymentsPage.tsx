...
import { CreditCard, AlertCircle, CheckCircle2, Plus, Search } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="space-y-3 p-4 bg-slate-900 border-slate-800 overflow-x-auto">
        {filteredPayments.length === 0 ? (
          <p className="text-xs text-slate-400 p-4 text-center">Ushbu oy uchun yozuvlar topilmadi.</p>
        ) : (
                  ...
                  <tr key={p.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="py-3 px-3 text-center">
                      {isUnpaid ? (
                        ...
                        <span className="text-[10px] text-emerald-400 font-bold">Muvaffaqiyatli saqlandi</span>
                      )}
                    </td>
                  </tr>
                );
