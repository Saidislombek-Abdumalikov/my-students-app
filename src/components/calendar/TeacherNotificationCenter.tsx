...
export const TeacherNotificationCenter: React.FC = () => {
  ...
  return (
    <Card className="space-y-4 bg-slate-900 border-slate-800 p-4">
      <div className="flex items-center justify-between border-b border-slate-800 pb-2">
        <div className="flex items-center space-x-2">
          <Bell className="w-4 h-4 text-emerald-400" />
          <h3 className="text-sm font-bold text-slate-100">O'qituvchi Bildirishnomalari</h3>
        </div>
      ...
      <div className="space-y-2.5 text-xs">
        ...
        <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between">
          <div className="space-y-0.5">
            <p className="font-bold text-slate-100 flex items-center gap-1.5">
              <CalendarCheck className="w-3.5 h-3.5 text-emerald-400" /> Rejalashtirilgan Darslar
            </p>
          ...
          <Link to="/attendance">
            <Button size="sm" variant="ghost" className="p-1 text-emerald-400">
        ...
        <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between">
          <div className="space-y-0.5">
            <p className="font-bold text-slate-100 flex items-center gap-1.5">
              <FileCheck className="w-3.5 h-3.5 text-amber-400" /> Vazifalarni Tekshirish
            </p>
            <p className="text-slate-400 text-[11px]">
          ...
          <Link to="/homework-check">
            <Button size="sm" variant="ghost" className="p-1 text-amber-400">
              <ArrowRight className="w-4 h-4" />
            </Button>
          </Link>
        </div>
        ...
        <div className="p-3 rounded-xl bg-red-950/40 border border-red-800 flex items-center justify-between">
          <div className="space-y-0.5">
            <p className="font-extrabold text-red-400 flex items-center gap-1.5">
              <AlertCircle className="w-3.5 h-3.5" /> QARZDOR O'quvchilar
            </p>
            <p className="text-red-300 font-bold text-[11px]">
              {unpaidPayments.length} ta o'quvchi to'lashi kerak.
            </p>
          </div>
          <Link to="/payments">
            <Button size="sm" variant="ghost" className="p-1 text-red-400">
              <ArrowRight className="w-4 h-4" />
            </Button>
          </Link>
        </div>
